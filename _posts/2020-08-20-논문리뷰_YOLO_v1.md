...
- GoogLeNet의 Inception 구조 대신 (1×1 reductino layer + 3×3 conv. layer 사용)<br/>
![Network Architecture](.\assets\yolov1_image\netwrok_architecture.png)<br/>
...
## Loss function
loss function을 뜯어보자  
![Loss fucntion](assets\yolov1_image\loss_function.png)<br/>
